...
return {
	...
	initUI = function(self)
		...
		if song == 3 then
			weeks:generateNotes(love.filesystem.load("charts/week3/poi" .. difficulty .. ".lua")())
		elseif song == 2 then
			weeks:generateNotes(love.filesystem.load("charts/week3/lalion" .. difficulty .. ".lua")())
		else
			weeks:generateNotes(love.filesystem.load("charts/week3/botan" .. difficulty .. ".lua")())
		end
	end,
