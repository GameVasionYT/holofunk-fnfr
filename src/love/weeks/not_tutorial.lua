...
return {
	...
	load = function(self)
		...
		inst = nil
		voices = love.audio.newSource("music/not tutorial/not fake tutorial.ogg", "stream")
	...
	initUI = function(self)
		...
		weeks:generateNotes(love.filesystem.load("charts/not tutorial/not-tutorial" .. difficulty .. ".lua")())
	end,
