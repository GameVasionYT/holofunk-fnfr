...
return {
	...
	load = function(self)
		...
		if song == 3 then
			...
			inst = love.audio.newSource("music/shark/haachama-inst.ogg", "stream")
			voices = love.audio.newSource("music/shark/haachama-voices.ogg", "stream")
		elseif song == 2 then
			inst = love.audio.newSource("music/shark/mythbuster-inst.ogg", "stream")
			voices = love.audio.newSource("music/shark/mythbuster-voices.ogg", "stream")
		else
			inst = love.audio.newSource("music/shark/sharkventure-inst.ogg", "stream")
			voices = love.audio.newSource("music/shark/sharkventure-voices.ogg", "stream")
		end
	...
	initUI = function(self)
		...
		if song == 3 then
			weeks:generateNotes(love.filesystem.load("charts/shark/haachama" .. difficulty .. ".lua")())
		elseif song == 2 then
			weeks:generateNotes(love.filesystem.load("charts/shark/mythbuster" .. difficulty .. ".lua")())
		else
			weeks:generateNotes(love.filesystem.load("charts/shark/sharkventure" .. difficulty .. ".lua")())
		end
	end,
