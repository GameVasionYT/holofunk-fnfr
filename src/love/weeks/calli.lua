...
return {
	...
	load = function(self)
		...
		if song == 3 then
			inst = love.audio.newSource("music/calli/callibattle-inst.ogg", "stream")
			voices = love.audio.newSource("music/calli/callibattle-voices.ogg", "stream")
		elseif song == 2 then
			inst = love.audio.newSource("music/calli/rip-inst.ogg", "stream")
			voices = love.audio.newSource("music/calli/rip-voices.ogg", "stream")
		else
			inst = love.audio.newSource("music/calli/live-again-inst.ogg", "stream")
			voices = love.audio.newSource("music/calli/live-again-voices.ogg", "stream")
		end
	...
	initUI = function(self)
		...
		elseif song == 2 then
			...
			weeks:generateNotes(love.filesystem.load("charts/calli/live-again" .. difficulty .. ".lua")())
		end
	end,
