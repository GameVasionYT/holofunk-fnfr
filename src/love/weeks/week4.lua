...
return {
	...
	load = function(self)
		weeks:load()
        if song == 4 then
            inst = love.audio.newSource("music/coco/hands-inst.ogg", "stream")
			voices = love.audio.newSource("music/coco/hands-voices.ogg", "stream")
		elseif song == 3 then
			inst = love.audio.newSource("music/coco/gangimari-inst.ogg", "stream")
			voices = love.audio.newSource("music/coco/gangimari-voices.ogg", "stream")
		elseif song == 2 then
			inst = love.audio.newSource("music/coco/cinderella-inst.ogg", "stream")
			voices = love.audio.newSource("music/coco/cinderella-voices.ogg", "stream")
		else
			inst = love.audio.newSource("music/coco/friday-nigh-inst.ogg", "stream")
			voices = love.audio.newSource("music/coco/friday-night-voices.ogg", "stream")
		end
	...
	initUI = function(self)
		weeks:initUI()
        if song == 4 then
            weeks:generateNotes(love.filesystem.load("charts/coco/hands" .. difficulty .. ".lua")())
		elseif song == 3 then
			weeks:generateNotes(love.filesystem.load("charts/coco/gangimari" .. difficulty .. ".lua")())
		elseif song == 2 then
			weeks:generateNotes(love.filesystem.load("charts/coco/cinderella" .. difficulty .. ".lua")())
		else
			weeks:generateNotes(love.filesystem.load("charts/coco/friday-night" .. difficulty .. ".lua")())
		end
	end,
