...
return graphics.newSprite(
	...
	
	{
		...
		["left"] = {start = 353, stop = 369, speed = 24, offsetX = -50, offsetY = -5}, -- Swapped
		["miss left"] = {start = 370, stop = 394, speed = 24, offsetX = -50, offsetY = -5}, -- Swapped
		["right"] = {start = 311, stop = 327, speed = 24, offsetX = 5, offsetY = -5}, -- Swapped
		["miss right"] = {start = 328, stop = 352, speed = 24, offsetX = 5, offsetY = -5}, -- Swapped
